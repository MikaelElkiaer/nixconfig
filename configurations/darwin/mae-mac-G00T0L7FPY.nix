...
in
{
  ...
  networking.hostName = "mae-mac-G00T0L7FPY";
  ...
  homebrew = {
    enable = true;
    brews = [
      # WARN: Needs to be pre-fetched
      # - HOMEBREW_GITHUB_API_TOKEN=$(gh auth token) brew fetch containdk/tap/...
    ...
    taps = [
      {
        name = "containdk/tap";
        clone_target = "https://github.com/containdk/homebrew.git";
      }
    ];
  };
